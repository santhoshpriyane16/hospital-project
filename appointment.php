...
if(isset($_POST['book']))
{
  ...
  $message=$_POST['message'];
	...
	$ins_qry=$conn->query("insert into appointment1 (name,phone,email,date,department,doctor,message) values('$name','$phone','$email','$date','$department','$doctor','$message')");

	if($ins_qry)

	{
		header("location:appointmentbooked.html");
	} else {
		echo "<script>
    ...
    <div class="row align-items-center">
      <div class="col-md-6">
        <div class="top-left text-center text-md-left">
          <h6>Opening Hours : Saturday to Tuesday - 10am to 10pm</h6>
        </div>
      </div>
      <div class="col-md-6">
        <div class="top-right text-center text-md-right">
          <ul class="social-links">
            ...
            <li>
              <a href="https://google-plus.com/" aria-label="google-plus">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <input class="form-control" name="name" type="text" name="Name" placeholder="Name" required="">
                </div>
                <div class="form-group">
                  <input class="form-control" name="email" type="email" name="Email" placeholder="Email" required="">
                </div>
                <div class="form-group">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  <input class="form-control" type="date" data-date-format="yyyy-mm-dd" name="date" placeholder="Date" required="" autocomplete="off">
              ...
              <div class="col-md-12">
                ...
                <div class="form-group text-center">
                  <button name="book" type="submit" class="btn-style-one">BOOK APPOINTMENT</button>
                </div>
              </div>
            </div>
          </form>
    ...
    <div class="row justify-content-center">
      <div class="col-lg-4 col-md-6">
        <div class="team-member">
          <img loading="lazy" src="images/team/Santhosh.jpg" alt="doctor" class="img-fluid">
          <div class="contents text-center">
            <h4>Dr.Santhosh Priyan E</h4>
            <p>ORTHOPEDIC</p>
            <a href="login.php" class="btn btn-main">Book Appointment</a>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-md-6">
        <div class="team-member">
          <img loading="lazy" src="images/team/Santhosh R.jpg" alt="doctor" class="img-fluid">
          <div class="contents text-center">
            <h4>Dr.SANTHOSH R</h4>
            <p>DIAGNOSTIC</p>
            <a href="login.php" class="btn btn-main">Book Appointment</a>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="team-member">
          <img loading="lazy" src="images/team/kamaludeen.jpg" alt="doctor" class="img-fluid">
          <div class="contents text-center">
            <h4>Dr.KAMALUDEEN</h4>
            <p>PSYCHOLOGY</p>
            <a href="login.php" class="btn btn-main">Book Appointment</a>
